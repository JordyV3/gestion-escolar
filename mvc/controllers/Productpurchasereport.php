...
class Productpurchasereport extends Admin_Controller {
    ...
    public function unique_date() {
        ...
        if($fromdate != '' && $todate == '') {
            $this->form_validation->set_message("unique_date", "El campo hasta la fecha no estará vacío .");
            return FALSE;
        }

        if($fromdate == '' && $todate != '') {
            $this->form_validation->set_message("unique_date", "El campo de fecha de inicio no estará vacío .");
            return FALSE;
        }
