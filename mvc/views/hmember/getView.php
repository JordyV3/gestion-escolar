                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_hname")?> </span>: <?=count($hostel) ? $hostel->name : 'S/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_htype")?> </span>: <?=count($hostel) ? $hostel->htype : 'S/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_class_type")?> </span>: <?=count($category) ? $category->class_type : 'S/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_tfee")?> </span>: <?=count($hmember) ? $hmember->hbalance : 'S/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_hostel_address")?> </span>: <?=count($hostel) ? $hostel->address : 'S/A' ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("hmember_joindate")?> </span>: <?php if(count($hmember)) { if($hmember->hjoindate) { echo date("d M Y", strtotime($hmember->hjoindate)); } } else { echo 'S/A'; } ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                ...
                <div class="modal-body">
                    ...
                    ?>
                        <label for="subject" class="col-sm-2 control-label">
                            <?=$this->lang->line("subject_email")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
