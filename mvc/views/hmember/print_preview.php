                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%"><?=count($hostel) ? $hostel->name : 'S/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_htype")?></th>
                            <td width="70%"><?=count($hostel) ? $hostel->htype : 'S/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_class_type")?></th>
                            <td width="70%"><?=count($category) ? $category->class_type : 'S/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_tfee")?></th>
                            <td width="70%"><?=count($hmember) ? $hmember->hbalance : 'S/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_hostel_address")?></th>
                            <td width="70%"><?=count($hostel) ? $hostel->address : 'S/A' ?></td>
                        </tr>
                        <tr>
                            <th width="30%"><?=$this->lang->line("hmember_joindate")?></th>
                            <td width="70%"><?php if(count($hmember)) { if($hmember->hjoindate) { echo date("d M Y", strtotime($hmember->hjoindate)); } } else { echo 'S/A'; }  ?></td>
                        </tr>
                        <tr>
