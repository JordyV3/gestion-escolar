...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> El estado "borrador y privado" esconden contenido de los motores de busqueda, la opción "visibilidad privado" esconde contenido del blog pero no de los motores de busqueda.</p>
    </div>
<?php } ?>
...
<script type="text/javascript">
    ...
    function setFileToEditor(ele, hiddenfield, ulClass) {
        ...
        if((hiddenfield != '' && hiddenfield != null) && (ulClass !='' && ulClass != null)) {
            ...
            toastr["error"]("Por favor seleccione uno.")
            toastr.options = {
                "closeButton": true,
                "debug": false,
                "newestOnTop": false,
