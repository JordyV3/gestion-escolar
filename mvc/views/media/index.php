            ...
            <div class="col-sm-12">
                ...
                <div class="box-body">
                    ...
                    <h5 class="page-header">
                        <button class="btn btn-success" data-toggle="modal" data-target="#folder"><span class="fa fa-folder"></span> <?=$this->lang->line('add_title')?></button>                
                    </h5>
                    <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-12">
                            <a class="btn btn-success" id="media-upload" data-toggle="modal" data-target="#file_upload">
...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> Comparta con usuarios archivos multimedia haciendo clic en el icono: <i class="fa fa-globe fa-2x"></i></p>
    </div>
<?php } ?>
<!-- folder end here -->
