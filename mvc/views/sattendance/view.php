                                                                        ...
                                                                        echo "<tr>";
                                                                            ...
                                                                            for ($i=1; $i <= 31; $i++) { 
                                                                                ...
                                                                                if(in_array($date, $holidaysArray)) {
                                                                                    ...
                                                                                    $leavedayCount++;
                                                                                    echo "<td class='ini-bg-purple'>".'LA'."</td>";
                                                                                } else {
                                                                                    $textcolorclass = '';
                                                                                    $val = false;
                                                                        ...
                                                                        echo "<tr>";
                                                                            ...
                                                                            for ($i=1; $i <= 31; $i++) { 
                                                                                ...
                                                                                if(in_array($date, $holidaysArray)) {
                                                                                    ...
                                                                                    $textcolorclass = 'ini-bg-secondary';
                                                                                    echo "<td class='".$textcolorclass."'>".'S/A'."</td>";
                                                                                }
                                                                            }
                                                                        echo "</tr>";
                                                                    }
    ...
    <?php if ($siteinfos->note==1) { ?>
        <div class="callout callout-info">
            ...
            Referencia 
                <ul>
                    <li>H   = Vacaciones</li>
                    <li>S/A = Sin Asistencia</li>
                    <li>P   = Presente (verde)</li>
                    <li>A   = Ausente (rojo)</li>
                    <li>LE  = Tarde con excusa (azul)</li>
                    <Li>L   = Tardío (amarillo)</Li>
                    <li>LA  = Licencia (purpura)</li>
                    <li>W   = Fin de semana (celeste)</li>
                </ul></p>
        </div>
    <?php } ?>
