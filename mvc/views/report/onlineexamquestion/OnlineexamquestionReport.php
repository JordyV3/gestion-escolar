    ...
    <?php } elseif($typeID == 2) { ?>
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-sm-12 headerInfo">
                    <h4 class="pull-left text-bold"><?=$this->lang->line('onlineexamquestionreport_exam')?> : <?=$exam->name?></h4>
                    <h4 class="pull-right text-bold"><?=$this->lang->line('onlineexamquestionreport_duration')?> : <?=($exam->duration) ? $exam->duration." ".$this->lang->line('onlineexamquestionreport_minute') : 'S/A'?></h4>
                </div>
