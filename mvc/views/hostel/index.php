...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> El Hostal o alojamiento se refiere a cuartos o habitaciones de los estudiantes ya sea dentro de la institución u hoteles privados.</strong>
        </p>
    </div>
<?php } ?>