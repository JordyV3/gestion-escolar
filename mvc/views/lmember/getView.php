                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_lID")?> </span>: <?=count($lmember) ? $lmember->lID : 'S/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_lfee")?> </span>: <?=count($lmember) ? $lmember->lbalance : 'S/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("lmember_joindate")?> </span>: <?=count($lmember) ? date("d M Y", strtotime($lmember->ljoindate)) : 'S/A'?></p>
                                    </div>
                                    <div class="profile-view-tab">
