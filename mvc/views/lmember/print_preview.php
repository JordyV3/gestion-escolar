            ...
            <div class="areaBottom">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td width="70%"><?=count($lmember) ? $lmember->lID : 'S/A'?></td>
                    </tr>
                    <tr>
                        <td width="30%"><?=$this->lang->line('lmember_libraryFee')?></td>
                        <td width="70%"><?=count($lmember) ? $lmember->lbalance : 'S/A'?></td>
                    </tr>
                    <tr>
                        <td width="30%"><?=$this->lang->line('lmember_joinDate')?></td>
                        <td width="70%"><?php if(count($lmember)) { if($lmember->ljoindate) { echo date('d M Y',strtotime($lmember->ljoindate)); } } else { echo 'S/A'; } ?></td>
                    </tr>
                    <tr>
