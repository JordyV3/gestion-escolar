                ...
                <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) { ?>
                    <?php if(permissionChecker('leaveapply_add')) { ?>
                        <h5 class="page-header">
                            <a class="btn btn-success"  href="<?php echo base_url('leaveapply/add') ?>">
...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> Todo los usuarios pueden solicitar permiso de asistencia excepto el administrador.</p>
    </div>
<?php } ?>