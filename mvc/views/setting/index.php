                        ...
                        <div class="form-group <?=form_error('sname') ? 'has-error' : ''?>" >
                            <div class="col-sm-12">
                                <label for="sname"><?=$this->lang->line("setting_school_name")?>
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="establece el título de tu sitio aquí"></i>
                                </label>
                        ...
                        <div class="form-group <?=form_error('phone') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="phone"><?=$this->lang->line("setting_school_phone")?>
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Establecer el número de teléfono de la organización aquí"></i>
                                </label>
                        ...
                        <div class="form-group <?=form_error('email') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="email"><?=$this->lang->line("setting_school_email")?>
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Establecer la dirección de correo electrónico de la organización aquí"></i>
                                </label>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('address') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="address"><?=$this->lang->line("setting_school_address")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Establecer la dirección de la organización aquí"></i>
                                </label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('footer') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="footer"><?=$this->lang->line("setting_school_footer")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Establecer el texto del pie de página del sitio aquí"></i>
                                </label>
                        ...
                        <div class="form-group <?=form_error('currency_code') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="currency_code">
                                    <?=$this->lang->line("setting_school_currency_code")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Configure el código de moneda de la organización como USD o GBP"></i>
                                </label>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('currency_symbol') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="currency_symbol"><?=$this->lang->line("setting_school_currency_symbol")?> &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Establecer el sistema de moneda de la organización aquí como $ o £"></i>
                                </label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?php if(form_error('language_status')) { echo 'has-error'; } ?>">
                            <div class="col-sm-12">
                                <label><?=$this->lang->line("setting_language")?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Habilitar/Inhabilitar idioma para la sección superior"></i>
                                </label>
                                <?php
                        ...
                        <div class="form-group <?=form_error('lang') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="lang"><?=$this->lang->line("setting_school_lang")?>
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Seleccione el idioma predeterminado de la organización aquí"></i>
                                </label>
                                <?php
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('school_year') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="school_year"><?=$this->lang->line("setting_school_default_school_year")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Escolar año escolar en curso"></i>
                                </label>
                                <?php
                                    $array = array(
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('attendance') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="attendance"><?=$this->lang->line("setting_school_default_attendance")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Seleccione el sistema de asistencia escolar predeterminado"></i></label>
                                <?php
                                    $array = array(
                        ...
                        <div class="form-group <?=(form_error('auto_invoice_generate') || form_error('automation')) ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="auto_invoice_generate"><?=$this->lang->line("setting_school_auto_invoice_generate")?>
                                    <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Habilitar/deshabilitar la tarifa de biblioteca, tarifa de hospedaje, factura de tarifa de transporte en la cuenta del estudiante automáticamente. Se agregará mensualmente."></i>
                                </label>
                                <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('note') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="note"><?=$this->lang->line("setting_school_note")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Habilitar / Deshabilitar la nota de ayuda del módulo"></i>
                                </label>
                                <?php
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?php if(form_error('weekends')) { echo 'has-error'; } ?>">
                            <div class="col-sm-12">
                            <label><?=$this->lang->line('setting_weekends')?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Seleccione los fines de semana"></i></label>
                                <?php
                                    $array = array(
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('frontendorbackend') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="frontendorbackend"><?=$this->lang->line("setting_school_frontend")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Habilitar/Deshabilitar el sitio frontend"></i>
                                </label>
                                    <?php
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('google_analytics') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="google_analytics"><?=$this->lang->line("setting_school_google_analytics")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Código del sitio google_analytics"></i>
                                </label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?php if(form_error('profile_edit')) { echo 'has-error'; } ?>">
                            <div class="col-sm-12">
                                <label><?=$this->lang->line("setting_school_profile_edit")?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Habilitar/Deshabilitar para editar el perfil"></i>
                                </label>
                                <?php
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('time_zone') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="time_zone"><?=$this->lang->line("setting_school_time_zone")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Seleccione la zona horaria de su región. Definimos una zona horaria como una región donde se utiliza la misma hora estándar"></i>
                                </label>
                                    <?php
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('ex_class') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="ex_class"><?=$this->lang->line("setting_graduate_class")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="Un graduado o exalumno de una escuela específica"></i>
                                </label>
                                    <?php
                    ...
                    <div class="col-sm-4">
                        <div class="form-group <?=form_error('photo') ? 'has-error' : ''?>">
                            <div class="col-sm-12">
                                <label for="photo"><?=$this->lang->line("setting_school_photo")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="Establecer logo de organización aquí"></i>
                                </label>
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if(form_error('captcha_status')) { echo 'has-error'; } ?>">
                        <div class="col-sm-12">
                            <label><?=$this->lang->line("setting_captcha")?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Compruebe si deshabilita el captcha en el inicio de sesión"></i>
                            </label>
                            <?php
                    ...
                    <div class="form-group <?php if(form_error('recaptcha_site_key')) { echo 'has-error'; } ?>" id="recaptcha_site_key_id">
                        <div class="col-sm-12">
                            <label for="recaptcha_site_key">
                                ...
                                &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Establecer clave de sitio recaptcha. Tenga cuidado Si no es válido, entonces no puede iniciar sesión."></i>
                            </label>
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if(form_error('recaptcha_secret_key')) { echo 'has-error'; } ?>" id="recaptcha_secret_key_id" >
                        <div class="col-sm-12">
                            <label for="recaptcha_secret_key"><?=$this->lang->line("setting_school_recaptcha_secret_key")?>&nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Establecer clave secreta Recaptcha. Tenga cuidado Si no es válido, entonces no puede iniciar sesión."></i>
                            </label>
            ...
            <fieldset class="setting-fieldset">
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if(form_error('attendance_notification')) { echo 'has-error'; } ?>">
                        <div class="col-sm-12">
                            <label><?=$this->lang->line("setting_attendance_notification")?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Seleccione Notificación de Asistencia"></i>
                            </label>
                            <?php
                                $array = array(
                ...
                <div class="col-sm-4" id="mainSmsDiv">
                    <div class="form-group <?php if(form_error('attendance_smsgateway')) { echo 'has-error'; } ?>" id="attendance_smsgateway_div">
                        <div class="col-sm-12">
                            <label><?=$this->lang->line("setting_attendance_smsgateway")?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Seleccione Sms Gateway"></i>
                            </label>
                            <?php
                                $array = array(
                ...
                <div class="col-sm-4">
                    <div class="form-group <?php if(form_error('attendance_notification_template')) { echo 'has-error'; } ?>" id="attendance_notification_template_div">
                        <div class="col-sm-12">
                            <label><?=$this->lang->line("setting_attendance_notification_template")?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Seleccione la plantilla de notificación de asistencia"></i>
                            </label>
                            <?php
        ...
        $('.backendThemeEvent').click(function() {
            ...
            if(id) {
                $.ajax({
                    ...
                    dataType: "html",
                    success: function(data) {
                        $('#headStyleCSSLink').attr('href', "<?=base_url('assets/lesson/themes/')?>"+data+"/style.css");
                        $('#headLessonCSSLink').attr('href', "<?=base_url('assets/lesson/themes/')?>"+data+"/lesson.css");
