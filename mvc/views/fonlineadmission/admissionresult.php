<div class="mainadmissionslip">
		...
		<div class="mainArea">
			<div class="areaTop">
				...
				<div class="studentProfile">
					...
					<div class="singleItem">
						<div class="single_label">Nombre</div>
						<div class="single_value">: <?=$admission['name']?></div>
					</div>
					<div class="singleItem">
						<div class="single_label">Elegir Clase</div>
			...
			<div class="areaBottom">
				<table class="table table-bordered">
					...
					<tr>
						<td width="30%">Fecha de cumpleaños</td>
	...
	<div class="admissionprint">
		<button class="btn btn-success" onclick="javascript:printDiv('admissioninfo')">Imprimir</button>
	</div>
</div>
