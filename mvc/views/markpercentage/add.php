            ...
            <div class="col-sm-12">
                ...
                <?php if ($siteinfos->note==1) { ?>
                    <div class="callout callout-info">
                        <p><i class="fa fa-info-circle fa-2x"></i> Después de agregar un nuevo porcentaje de calificación, seleccione este porcentaje en la configuración general para activar este nuevo porcentaje en la calificación.</p>
                    </div>
                <?php } ?>
