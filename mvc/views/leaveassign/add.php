...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> Antes debe agregar una categoría, una vez asignado el permiso los usuarios tendrán habilitado la opción de categoría.</p>
    </div>
<?php } ?>
