                ...
                <?php if(($siteinfos->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) { ?>
                    <?php if(permissionChecker('complain_add')) { ?>
                        <h5 class="page-header">
                            <a class="btn btn-success"  href="<?php echo base_url('complain/add') ?>">
...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> Todo los usuarios pueden realizar un reclamo o sugerencia sobre la institución.</p>
    </div>
<?php } ?>