            ...
            <div class="col-sm-12">
                ...
                <?php if ($siteinfos->note==1) { ?>
                    <div class="callout callout-info">
                        <p><i class="fa fa-info-circle fa-2x"></i> El administrador puede agregar una plantilla personalizada antes de enviar correos electrónicos o sms, lo que lo ayudará a enviar correos electrónicos / sms muy rápidamente.</p>
                        <p>Para agregar una nueva plantilla abrir menu "ADMINISTRADOR" y elegir "Plantilla de Correo y SMS"</p>
                    </div>
                <?php } ?>
