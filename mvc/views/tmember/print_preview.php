                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="70%"><?=count($transport) ? $transport->route : 'S/A'?></td>
                        </tr>
                        <tr>
                            <td width="30%"><?=$this->lang->line("tmember_tfee")?></td>
                            <td width="70%"><?=count($tmember) ? $tmember->tbalance : 'S/A'?></td>
                        </tr>
                        <tr>
                            <td width="30%"><?=$this->lang->line("tmember_joindate")?></td>
                            <td width="70%"><?php if(count($tmember)) { if($tmember->tjoindate) { echo date("d M Y", strtotime($tmember->tjoindate)); } } else { echo 'S/A'; }   ?></td>
                        </tr>
                        <tr>
