            ...
            <div class="col-sm-12">
                ...
                <?php if ($siteinfos->note==1) { ?>
                    <div class="callout callout-info">
                        <p><i class="fa fa-info-circle fa-2x"></i> Si selecciona el cuadro selección de usuario de formulario de estudiante, aparecerá una palabra clave en el cuadro de etiquetas. Puede hacer clic en cualquiera de las etiquetas para insertar en el campo de la plantilla. Si inserta la etiqueta <b> [name] </b>, cuando envíe un correo electrónico, representará el nombre del estudiante en ese lugar.</p>
