        ...
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <h5 class="page-header">
                        ...
                        ?>
                            <a class="btn btn-success" href="<?php echo base_url('schoolyear/add') ?>">
...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> Asegúrese de tener los próximos años para hacer uso de ellos.</p>
    </div>
<?php } ?>