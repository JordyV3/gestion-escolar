                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group <?php if(form_error('email_engine')) { echo 'has-error'; } ?>">
                            <div class="col-sm-12">
                                <label><?=$this->lang->line("emailsetting_email_engine")?>&nbsp; <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="bottom" title="Seleccione el motor de correo electrónico"></i>
                                </label>
                                <?php
                                    $array = array(
                        ...
                        <div class="form-group <?=form_error('smtp_port') ? 'has-error' : ''?>" >
                            <div class="col-sm-12">
                                <label for="smtp_port"><?=$this->lang->line("emailsetting_smtp_port")?>
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="configura tu puerto smtp"></i>
                                </label>
                        ...
                        <div class="form-group <?=form_error('smtp_security') ? 'has-error' : ''?>" >
                            <div class="col-sm-12">
                                <label for="smtp_security"><?=$this->lang->line("emailsetting_smtp_security")?>
                                    &nbsp;<i class="fa fa-question-circle" data-toggle="tooltip" data-placement="right" title="configura tu seguridad smtp"></i>
                                </label>
...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> Los datos SMTP debe solicitarlo a su proveedor de hosting, para pruebas de correo puede hacer uso de <a href="https://mailtrap.io/">MAILTRAP</a></p>
    </div>
<?php } ?>
