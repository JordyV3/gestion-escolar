...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> Utilice el proveedor de su preferencia:
            <ul>
                <li><a href="https://clickatell.com" target="_blank">Clickatell</a></li>
                <li><a href="https://twilio.com" target="_blank">Twilio</a></li>
                <li><a href="https://bulksms.com" target="_blank">Bulk</a></li>
                <li><a href="https://msg91.com" target="_blank">MSG91</a></li>
            </ul>
        </p>
    </div>
<?php } ?>
