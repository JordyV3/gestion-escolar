...
<?php if ($siteinfos->note==1) { ?>
    <div class="callout callout-info">
        <p><i class="fa fa-info-circle fa-2x"></i> Antes de realizar transacciones con estas plataformas utilice su <strong>cuenta de pruebas o desarrollo para verificar el estado.</strong>
        </p>
    </div>
<?php } ?>
