    	...
    	<div class="container register">
            <div class="row">
                <div class="col-md-3 register-left">
                    ...
                    <h3>Bienvenido</h3>
                    <p>Confiamos en que la siguiente información ayudará a cada futura familia y estudiante a comprender nuestros procedimientos de admisión, incluida toda la documentación necesaria para procesar una solicitud de admisión.</p>
                </div>
                <div class="col-md-9 register-right">
                    <div class="register-form">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="admissionID" name="admissionID" placeholder="Admisión ID *" />
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-success form-control" id="getadmissionresult">Obtener resultado</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="mainregisterForm" id="mainregisterForm">                        
                            <h3 class="register-heading">Admisión para estudiante</h3>
                            <form id="admissionForm" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="dob" id="dob" placeholder="Fecha de cumpleaños *" />
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="button" class="btnRegister"  value="Solicitar"/>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<style type="text/css">
    .register {
        background: -webkit-linear-gradient(left, #2c5f87, #0bbc64);
        margin-top: 3%;
        padding: 3%;
    }
...
@section('footerAssetPush')
    ...
    <script type="text/javascript">
        ...
        $('#getadmissionresult').click(function(e) {
            ...
            if(admissionID == '') {
                error++;   
                errorMessage("Se requiere el campo de Identificación de Admisión.");
            } else {
                if(!((Math.floor(admissionID) == admissionID) && $.isNumeric(admissionID))) {
                    error++;
                    errorMessage("El valor del campo Id. De admisión no es válido.");
                }
            }
